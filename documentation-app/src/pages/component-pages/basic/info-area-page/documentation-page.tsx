  ...
  codeExamples: [
    {
      ...
      code: '<InfoArea className="m-2"><p>You can emphasize a paragraph by using the InfoArea component. It makes the text stand out, and it uses your theming variables.</p></InfoArea>',
      scope: { InfoArea },
    },
    {
      title: 'Tooltip',
      description: <>InfoArea can be used to make a styled tooltip.</>,
      code: '<InfoArea className="m-2"><p>Tip: You can make pretty tooltips</p></InfoArea>',
      scope: { InfoArea },
    },
    {
      title: 'Children can be anything',
      description: <>Get create - you can provide any HTML element.</>,
      code: '<InfoArea className="m-2"><p>InfoArea using a link - <a href="https://maincode-org.github.io/maincode-ui/overview">See documentation page</a></p></InfoArea>',
      scope: { InfoArea },
    },
  ],
  props: [
