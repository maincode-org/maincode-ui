...
<DocumentationSection
  ...
  mainText={<InfoArea className='mt-3'>DocumentationRouterWithPageContent uses this component internally to render all the pages provided to it.</InfoArea>}
  props={[{ title: 'className', description: 'Classes for custom styling', type: 'string', required: false, defaultValue: '""'}]}
