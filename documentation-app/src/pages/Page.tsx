  ...
  return (
    <IonPage>
      ...
      <IonContent ref={ionContentRef} className={styles.ionContent} fullscreen>
        {documentationPages.map((c, i, elements) => (
          <Route
            key={i}
...
const makeContent = (c: IDocumentationPage, prevNav?: IFooterNav, nextNav?: IFooterNav): React.ReactNode => (
  <>
    <DocumentationSection className='px-2 pb-1' description={c.description} props={c.props} styles={c.styles} customContent={c.customContent} prevNav={prevNav} nextNav={nextNav}>
      {LiveEditExample}
