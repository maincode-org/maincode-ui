...
const SimulationContainer: React.FC<IProps> = ({ id, onLoad, backgroundColor = 'rgba(0,0,0,0)', className = '', children }) => {
  ...
  return (
    <section
      id={id}
      ref={sectionRef}
      style={{ maxHeight: `${dim}px`, height: `${dim}px`, maxWidth: `${dim}px`, width: `${dim}px`, backgroundColor: backgroundColor }}
